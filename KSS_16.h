...
mpz_t X;
mpz_t X1;
mpz_t PRIME_P,order_r,trace_t, order_EFp, a_x, EFp_total, EFp16_total;
mpz_t tmp_a;
mpz_t minus1_root1,minus1_root2;
...
void EFp4_Skew_Frobenius_p4(struct EFp4 *ANS, struct EFp4 *Qt);
void EFp4_Skew_Frobenius_p5(struct EFp4 *ANS, struct EFp4 *Qt);
void EFp4_Skew_Frobenius_p6(struct EFp4 *ANS, struct EFp4 *Qt);
void EFp4_Skew_Frobenius_p7(struct EFp4 *ANS, struct EFp4 *Qt);

void generate_X(void);
void pre_calc_vector_final_exp(void);
void pre_calculate_frob_p(void);
void pre_calculate_frob_p2(void);
void pre_calculate_frob_p3(void);
void pre_calculate_frob_p4(void);
void pre_calculate_frob_p5(void);
void pre_calculate_frob_p6(void);
void pre_calculate_frob_p7(void);
void pre_calculate_frob_p8(void);
void pre_calculate_root_minus1(void);
void weil(void);
void dealloc_constants(void);
...
void check_G2_SCM(void);
void check_G2_order(void);
//-----------------------------------------------------------------------------------------
#pragma mark G3 EXP methods
void G3_EXP_2split(struct Fp16 *ANS,struct Fp16 *P, mpz_t scalar);
void G3_EXP_2split_JSF(struct Fp16 *ANS,struct Fp16 *P, mpz_t scalar);
void check_G3_EXP(void);
